...
<div class="navbar-header">
    ...
    <a class="navbar-brand" href="index.html"> <img src="{{ URL::asset('static/admin/assets/images/logo.png') }}" alt="Packet"/> </a>
    <a class="navbar-brand navbar-brand-collapsed" href="index.html"> <img src="{{ URL::asset('static/admin/assets/images/logo.png') }}" alt="" /> </a>
</div>
<!-- end: NAVBAR HEADER -->
